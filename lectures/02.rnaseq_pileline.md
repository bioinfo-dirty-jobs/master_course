...
In this session we want to perform differentil expression using pseudomapping approach from kallisto and  Sleuth for call differential expression genes.
